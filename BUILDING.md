# Building JuicyCensor 2.1.0

Use Windows x64, Python 3.12 for the frozen GUI (2.1.0 was built with 3.12.14), PyInstaller 6.21.0, PySide6 6.11.2,
...
2. Tag that exact commit `v2.1.0` and push the tag.
